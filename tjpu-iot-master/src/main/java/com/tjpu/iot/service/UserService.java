...
public class UserService {
     ...
     * @return
     */
    public ResponseResult deleteUser(String userId, HttpSession session) {
     ...
     * @return
     */
    public ResponseResult queryUser(String userId, HttpSession session) {
     ...
     * @return
     */
    public ResponseResult queryAllUsers(HttpSession session) {
