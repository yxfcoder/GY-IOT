...
public class UserController {
    ...
    public ResponseResult add(@RequestBody User user, HttpSession session) {
    ...
    public ResponseResult delete(@PathVariable("userId") String userId, HttpSession session) {
    ...
    public ResponseResult queryOne(@PathVariable("userId") String userId, HttpSession session) {
        log.info("[UserController] queryOne() 进入查询用户方法");
        return userService.queryUser(userId, session);
    }
    ...
    public ResponseResult queryAll(HttpSession session) {
        ...
        return userService.queryAllUsers(session);
    }
